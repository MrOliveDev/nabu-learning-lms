...
<style>
    :root {
        --company-c:
            <?php echo '#'. $interfaceCfg->Companies->c;
        ?>;
        --company-h:
            <?php echo '#'. $interfaceCfg->Companies->h;
        ?>;
        --training-c:
            <?php echo '#'. $interfaceCfg->TrainingCourses->c;
        ?>;
        --training-h:
            <?php echo '#'. $interfaceCfg->TrainingCourses->h;
        ?>;
        --session-c:
            <?php echo '#'. $interfaceCfg->Sessions->c;
        ?>;
        --session-h:
            <?php echo '#'. $interfaceCfg->Sessions->h;
        ?>;
        --template-c: #ffc61a;
        --template-h: #c29100;
    }
                ...
                <div class="list-group" id="template-list-tab" role="tablist">
                    ...
                    <a class="list-group-item list-group-item-action p-0 border-transparent border-5x template_{{ $template->id }}"
                        ...
                        <div class="btn-group float-right">
                            <button class="btn item-edit" data-content='template' data-item-id="{{ $template->id }}">
                                <i class="px-2 fa fa-edit"></i>
                            </button>
                            <button class="btn item-delete" data-content='template' data-item-id="{{ $template->id }}">
        ...
        <div class="card-body  p-3">
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="template_name" name="template_name" value="" required>
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
            ...
            <div class="form-group clearfix">
                <button type="submit" class="btn btn-hero-primary float-right mx-1 submit-btn" id="template_save_button"
                    data-form="template_form">SAVE</button>
                ...
                <div class="card bg-white text-black mx-2">
                    <div class="card-body  p-3">
                        ...
                        <div class="form-group" id='status-form-group'>
                            <div class="custom-control custom-switch custom-control-lg mb-2 ml-0 " id="status_checkbox">
