        ...
        <fieldset id="MailPanel">
            ...
            <div id="div_C" class="top">
                <div id="generer" class="ml-4">
                        ...
                        <div class="w-100 p-2 sliderStyle">
                            <div id="doc-type-list">
                                @foreach ($templates as $template)
                                    <div class="doc-type-item" onclick="selectModel({{ $template['id'] }})"
                                        id="doc-type-item-{{ $template['id'] }}">
                                        <span
                                            id="doc-type-item-title-{{ $template['id'] }}">{{ $template['name'] }}</span>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                                ...
                                <tbody id="usersList">
                                    <tr style="border: 1px solid #7e3e98; cursor: pointer;">
                                        <td class="text-center"
                                            style="padding: 0; background-color: #7e3e98; border: 0px;">
                                            <input
                                                style="cursor: pointer; filter: hue-rotate(120deg); transform: scale(1.3);"
                                                type="checkbox" id="sendcheck_all" checked>
                                        </td>
                                    </tr>
                                    @forelse($users as $user)
                                        <tr class="user-item">
                                            <td class="text-center userAction">
                                                <input type="checkbox" id="sendcheck_{{ $user['id'] }}"
                                                    class="sendcheck"
                                                    style="cursor:pointer; filter: hue-rotate(120deg); transform: scale(1.3);"
                                                    checked>
                                            </td>
                                            <td class="font-w600 userName" id="user-name-{{ $user['id'] }}">
                                                {{ $user['first_name'] . ' ' . $user['last_name'] }}</td>
                                            <!-- <td class="font-w600 text-center userAction" onclick="sendMail({{ $user['id'] }})"><i class="fa fa-envelope"></i></td> -->
                                            <td class="font-w600 text-center userAction"
                                                onclick="previewMail({{ $user['id'] }})">Preview <i
                    ...
                    <fieldset id="genererRight">
                        <div class="mb-4">
                            ...
                            <span class="bg-white text-black p-2 rounded">
                                <input class="input-field border-0 mw-100 model-name-input" type="text"
                                    style="width: 350px;" id="from-address" value="{{ $fromAddress }}">
                            </span>
                        </div>
                        <div class="mb-4">
                            ...
                            <span class="bg-white text-black p-2 rounded">
                                <input class="input-field border-0 mw-100 model-name-input" type="text"
                                    style="width: 350px;" id="to-address">
                            </span>
                        </div>
                        <div class="mb-3">
                            ...
                            <span class="bg-white text-black p-2 rounded">
                                <input class="input-field border-0 mw-100 model-name-input" type="text"
                                    style="width: 350px;" id="send-subject">
                            </span>
                        </div>
                ...
                <div id="historique" class="ml-4">
                    ...
                    <button type='button' class='js-swal-confirm btn btn-danger mr-3 p-3' onclick='delMails()'
                ...
                <div id="modeles" class="ml-4">
                    <fieldset id="modelLeft">
                                ...
                                @foreach ($templates as $template)
                                    <div class="model-item" id="model-item-{{ $template['id'] }}">
                                        ...
                                        <div>
                                            ...
                                            <i class="fa fa-trash mr-3 dangerBtn"
                                                onclick="delTemplate({{ $template['id'] }})"></i>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <div id="horizSplit4" class="handler_horizontal  text-center  font-size-h3 mb-4"
                            style="color: #362f81;">
                            <i class="fas fa-grip-lines"></i>
                        </div>
                                    ...
                                    <div id="imagePreviews">
                                        @foreach ($images as $image)
                                            <img src="{{ $image['data'] }}" alt="image"
                                                class="model-drag-item previewImg" width="100" height="100"
                    ...
                    <fieldset id="modelRight">
                        <div class="mb-4">
                            ...
                            <span class="bg-white text-black p-2 rounded">
                                <input class="input-field border-0 mw-100 model-name-input" type="text"
                                    style="width: 350px;" id="model-name">
                            </span>
                        </div>
                        <div class="mb-3">
                            <span class="text-white mr-1">Subject *</span>
                            <span class="bg-white text-black p-2 rounded">
                                <input class="input-field border-0 mw-100 model-name-input" type="text"
                                    style="width: 350px;" id="mail-subject">
                            </span>
                        </div>
            ...
            <div class="modal myModal fade" id="image-crop-modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
                aria-hidden="true">
            ...
            <div class="modal fade" id="progressModal" tabindex="-1" role="dialog" aria-labelledby="modal-block-popout"
                aria-hidden="true">
                    ...
                    reader.onloadend = function() {
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                if (res.success) {
                                    $("#imagePreviews").append('<img src="' + res.src +
                            ...
                            error: function(err) {
                                Dashmix.helpers('notify', {
                                    type: 'danger',
                                    icon: 'fa fa-times mr-1',
                                    message: "Sorry, You have an error!"
                                });
                            }
                        });
                    }
