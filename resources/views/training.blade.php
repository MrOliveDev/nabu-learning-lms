...
<div id="content" data-training-display="{{ isset(session('permission')->training->training->display) }}"
        ...
        <div class="clear-fix text-white mb-3 toolkit  d-flex justify-content-lg-start flex-column mx-4"
            ...
            <div class="w-100 p-2">
                ...
                <div class="input-container float-right">
                    <a href="#" class="float-left toolkit-lesson-multi-delete">
            ...
            <div class="filter p-2 toolkit-filter">
                <div class="float-left">
                    ...
                    <select class="status-switch-2">
                        <option value="all" selected>ALL LANG</option>
        ...
        <div id="div_A" class="window top">
            <div class="clear-fix mx-4">
                <div class="list-group" id="list-tab" role="tablist" data-src=''>
                    @if (isset(session('permission')->training->lesson->display) && !empty($lessons[0]['lesson']))
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="lesson_duration"
                                        name="lesson_duration" value="" required="">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                        ...
                        <div class="template-select bg-white text-black">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <select class="form-control" id="fabrique-template-select"
                                        name="fabrique-template-select">
                                        @foreach ($templates as $template)
                                            @if ($loop->first)
                                                <option value="{{ $template->alpha_id }}" selected="selected">
                                                    {{ $template->name }}</option>
    ...
    echo 'drag-disable';
            ...
            <div id="div_D" class="window bottom">
                ...
                <div class=" mx-4" id="nav-tabContent">
                    <form method="post" id="training_form" enctype="multipart/form-data" class="form"
                        action="" autocomplete="off" data-cate="" data-item="">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        ...
                        <div class="card text-black">
                            <div class="justify-content-center flex-wrap pb-3" style="overflow:hidden;">
                                <div style="text-align: center;">
                                    ...
                                    <img src="" alt="" id="preview-rect" width="480px" height="270px" name="preview"
                                        style="margin-left:auto;margin-right:auto;margin-top:20px;border:1px solid black;padding:5px;" />
                        ...
                        <div class="modal-content" style="width: 600px;">
                            <div class="block block-themed block-transparent mb-0">
                                ...
                                <div class="block-content">
                                    <p>Cette fonction vous permet d'exporter la totalité de la formation au format ZIP
                                        compatible SCORM 2004 3em édition. Cette opération peut prendre plusieurs
                                        dizaines de minutes. Une fois terminée, vous recevrez un email avec un lien pour
                                        télécharger le fichier zip. Cliquez sur le bouton Exportation SCORM pour
                                        confirmer ou Annuler pour revenir à l'écran formation</p>
                                    <div class="row mb-3">
                                        <div class="col-3">
                                            Template
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-9 input-group">
                                            <input type="text" class="form-control" id="scorm-threshold-score"
                                                value="80">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            <input type="text" class="form-control" id="scorm-eval-attempt"
                                                value="5">
                                        </div>
                                    </div>
                                </div>
                                <div class="block-content block-content-full text-right bg-light">
                                    ...
                                    <button type="button" class="btn btn-sm btn-primary" data-dismiss="modal"
                                        onclick="generateScorm()">Generate</button>
                                </div>
                            </div>
                        </div>
                    </div>
