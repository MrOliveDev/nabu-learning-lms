                ...
                <form class="js-validation-signup" action="{{ route('register') }}" method="POST">
                    ...
                    <div class="py-3">
                        <div class="form-group">
                            ...
                            <input id="login" type="text" class="form-control form-control-lg form-control-alt" name="login"
                        ...
                        <div class="form-group">
                            <!-- <input type="text" class="form-control form-control-lg form-control-alt" id="signup-username" name="signup-username" > -->
                            <input id="name" type="text" class="form-control form-control-lg form-control-alt"
                        ...
                        <div class="form-group">
                            <!-- <input type="text" class="form-control form-control-lg form-control-alt" id="signup-username" name="signup-username" > -->
                            <input id="name" type="text" class="form-control form-control-lg form-control-alt"
                                name="lastname" value="{{ old('lastname') }}" autocomplete="lastname" required autofocus
                        ...
                        <div class="form-group">
                            <input id="email" type="email" class="form-control form-control-lg form-control-alt"
                        ...
                        <div class="form-group">
                            <input id="password" type="password" class="form-control form-control-lg form-control-alt"
                        ...
                        <div class="form-group">
                            <input id="password-confirm" type="password"
                                class="form-control form-control-lg form-control-alt" required
                                autocomplete="password-confirm" placeholder="Password Confirm">
