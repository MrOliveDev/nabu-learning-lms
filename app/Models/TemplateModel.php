...
class TemplateModel extends Model
{
    ...
    protected $fillable = [
        'alpha_id', 'name', 'code', 'id_creator', 'style', 'published', 'creation_date'
    ];
    ...
    public function getParcoursCoursLang($datas) { // Fonction ajax pour recup le parcours dans lire un cours admin player
